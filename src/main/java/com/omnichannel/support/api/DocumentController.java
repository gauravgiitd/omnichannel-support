...
public class DocumentController {
    ...
    public ResponseEntity<ApiResponse<List<DocumentDto>>> listDocuments(@PathVariable("ticketId") String ticketId) {
    ...
    public ResponseEntity<ApiResponse<DocumentDto>> registerDocument(
            @PathVariable("ticketId") String ticketId, @Valid @RequestBody RegisterDocumentRequest request) {
        DocumentDto created = ticketService.registerDocument(ticketId, request);
